...
const OrderDetails = () => {
  ...
  return (
    <div className="order-details-container">
      ...
      <OrderStages
        stages={
          order.stages && Array.isArray(order.stages) && order.stages.length > 0
            ? order.stages
        ...
        <div className="tracking-info-section">
          ...
          {isTrackingLoading ? (
            ...
            <div className="tracking-details">
              ...
              <p>
                <strong>Latitude:</strong> {trackData.locations[0].latitude}
              </p>
              <p>
                <strong>Longitude:</strong> {trackData.locations[0].longitude}
              </p>
            </div>
          ) : (
